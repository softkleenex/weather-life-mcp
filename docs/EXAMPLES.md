# Weather Life MCP 사용 예시 v3.7

> 날씨 조회부터 장소 검색, 스마트 분석까지! 다양한 상황별 사용 예시를 소개합니다.
...
## 18. 활동 비교 분석 (v3.7 NEW!)

### 두 활동 중 어떤 게 더 좋을지 비교
```
"캠핑 vs 피크닉, 오늘 뭐가 나을까?"
"등산이랑 러닝 중에 뭐가 좋아?"
"세차할까 빨래할까?"
...
{
  "comparison": {
    "캠핑": {"score": 75, "grade": "좋음"},
    "피크닉": {"score": 82, "grade": "최적"}
  },
  "winner": "피크닉",
  "score_difference": 7,
  "recommendation": "오늘은 피크닉이 7점 더 좋아요!",
  "weather_summary": "현재 15°C, 강수확률 10%"
}
```

### 지원 활동
캠핑, 피크닉, 등산, 빨래, 세차, 운동, 러닝, 골프, 낚시
...
5. **시간대 분석** - "언제 나가면 좋아?"로 최적 시간 확인 (v3.7)
6. **활동 비교** - "캠핑 vs 피크닉"으로 승자 분석 (v3.7)
7. **80개+ 지역 지원** - 서울 25개 구, 경기도, 광역시, 주요 도시
8. **실시간 데이터** - 기상청/에어코리아/카카오맵 실시간 연동
